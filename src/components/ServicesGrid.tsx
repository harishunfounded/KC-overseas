        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3 sm:gap-4">
          {siteConfig.services.map((service) => {
            ...
            return (
              ...
              >
                <div className="w-11 h-11 rounded-xl bg-slate-100 text-slate-700 flex items-center justify-center mb-2.5 group-hover:bg-kc-primary group-hover:text-white group-hover:scale-110 shadow-sm transition-all duration-200">
